...
-- Anti-Ban & Anti-Cheat Bypass
local oldNamecall
oldNamecall = hookmetamethod(game, "__namecall", function(self, ...)
    local args = {...}
    local method = getnamecallmethod()
    
    if method == "Kick" or method == "kick" or method == "FireServer" or method == "fireServer" then
        if args[1] == "Security" or args[1] == "Check" then
            return
        end
    end
...
local oldTeleport
oldTeleport = hookmetamethod(game, "Teleport", function(self, ...)
...
for _, v in pairs(game:GetDescendants()) do
    if v:IsA("Script") or v:IsA("LocalScript") then
        if v.Name:lower():find("anti") or v.Name:lower():find("detect") or v.Name:lower():find("check") then
            v.Disabled = true
        end
    end
end
...
local function getMethodLoading()
	...
	JKLL, JKLLJ = pcal(function() require(R.Util.CameraShaker):Stop() end);
	...
	function dist(position)
		...
		if not isUniversal then
			-- Fallback for non-universal executors
			if typeof(a) == "CFrame" then
				if selff.Character and selff.Character:FindFirstChild("HumanoidRootPart") then
		...
		-- Original Tp function code with universalWait
		...
		if not universalFindFirstChild(selff.Character, "Humanoid") then
			repeat universalWait(1) until universalFindFirstChild(selff.Character, "Humanoid") and universalFindFirstChild(selff.Character, "HumanoidRootPart")
			universalWait(1)
			KLLOP = selff.Character.HumanoidRootPart
			pKLLOP = KLLOP.Position
		end
		
		if universalFindFirstChild(selff.Character, "Humanoid") and selff.Character.Humanoid.Health <= 0 then
			repeat universalWait(1) until universalFindFirstChild(selff.Character, "Humanoid") and universalFindFirstChild(selff.Character, "HumanoidRootPart") and selff.Character.Humanoid.Health > 0
			universalWait(1)
			KLLOP = selff.Character.HumanoidRootPart
			pKLLOP = KLLOP.Position
		end
	...
	function AutoRaid(obj)
		...
		if SmalFruit ~= nil then
			CommF:InvokeServer("LoadFruit", SmalFruit);
			twait(0.3);
			...
			if not PSG.Main.Timer.Visible and (not FindFirstChild(W._WorldOrigin.Locations, "Island 1") or (FindFirstChild(W._WorldOrigin.Locations, "Island 1") and dist(FindFirstChild(W._WorldOrigin.Locations, "Island 1").CFrame.Position) > 6700)) then
				...
				repeat
					twait();
				until (FindFirstChild(W._WorldOrigin.Locations, "Island 1") and dist(FindFirstChild(W._WorldOrigin.Locations, "Island 1").CFrame.Position) <= 6700) or not selc or (selc and not FindFirstChild(selc, "Humanoid")) or selc.Humanoid.Health <= 0;
				tspawn(function()
					repeat
						twait();
...
local function getMethodLoading()
	...
	SRM = Section:NewDropdown({
		...
		Default = Configs.Raid.Manual.SelectRaid,
		Callback = function(a)
			Configs.Raid.Manual.SelectRaid = a;
		end,
	});
	Section:NewButton({
		Title = "Buy",
	...
	Section:NewToggle({
		...
		Default = false,
		Callback = function(tr)
			Configs.Raid.Manual.TeleportToNextIsland = tr;
		end,
	});
	Section:NewToggle({
		Title = "Kill Aura",
					...
					if Configs.ESP.Players then
						if v and v.Character and FindFirstChild(v.Character, "Head") and not FindFirstChild(v.Character.Head, AlwaysNameESP) then
							...
							if v.Team == selff.Team then
								...
								nameP.TextColor3 = Color3.fromRGB(255, 0, 0);
							end;
		...
		tspawn(function()
			while twait() do
				...
				--pcal(function()
									...
									if FindFirstChild(Enemy, "The Saw") then
										...
										pcal(function()
											if FindFirstChild(R, "The Saw") then
												...
												if Configs.Farming.Sea1.Hop then
													task.wait(3);
													if (not FindFirstChild(R, "The Saw") or not FindFirstChild(Enemy, "The Saw")) and Configs.Farming.Sea1.Hop and not Configs.Settings.AutoFarm.Stackable then
														Hop();
													end;
												end;
											end;
					...
					if AnySea2 then
						if AnySea2W then
							if Configs.Farming.Sea2.AutoFactory and not getInventory("Factory Key", "Check") then
								if FindFirstChild(Enemy, "Factory Staff") then
									pcal(function()
										for i,v in pir(Enem) do
											if v.Name == "Factory Staff" then
												if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
													...
													repeat twait(); TargetMobName = v.Name;
														Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
														SetHum(v); Hitc();
													until not v or not Configs.Farming.Sea2.AutoFactory or v.Humanoid.Health <= 0
												end;
											end;
										end;
									end);
									...
									pcal(function()
										if FindFirstChild(R, "Factory Staff") then
											if Configs.Teleport.TP_Bypass and R["Factory Staff"] then
												TpBypass(GetPivot(R["Factory Staff"]));
											end; twait(0.7)
											Tp(FindFirstChild(R, "Factory Staff").HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Factory Staff" then
											...
											if Configs.Farming.Sea2.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Factory Staff") or not FindFirstChild(Enemy, "Factory Staff")) and Configs.Farming.Sea2.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
							...
							if Configs.Farming.Sea2.AutoEctoplasm and not getInventory("Ectoplasm", "Check") then
								if FindFirstChild(Enemy, "Ectoplasm") then
									pcal(function()
										for i,v in pir(Enem) do
									...
									pcal(function()
										if FindFirstChild(R, "Ectoplasm") then
											if Configs.Teleport.TP_Bypass and R["Ectoplasm"] then
												TpBypass(GetPivot(R["Ectoplasm"]));
											end; twait(0.7)
											Tp(FindFirstChild(R, "Ectoplasm").HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Ectoplasm" then
											...
											if Configs.Farming.Sea2.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Ectoplasm") or not FindFirstChild(Enemy, "Ectoplasm")) and Configs.Farming.Sea2.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
							...
							if Configs.Farming.Sea2.AutoBartilo and not getInventory("Bartilo's Key", "Check") then
								if FindFirstChild(Enemy, "Bartilo") then
									pcal(function()
										for i,v in pir(Enem) do
											if v.Name == "Bartilo" then
												if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
													sethiddenproperty(selff,"SimulationRadius",math.huge);
													repeat twait(); TargetMobName = v.Name;
														Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
														SetHum(v); Hitc();
													until not v or not Configs.Farming.Sea2.AutoBartilo or v.Humanoid.Health <= 0
												end;
											end;
										end;
									end);
									...
									pcal(function()
										if FindFirstChild(R, "Bartilo") then
											if Configs.Teleport.TP_Bypass and R["Bartilo"] then
												TpBypass(GetPivot(R["Bartilo"]));
											end; twait(0.7)
											Tp(FindFirstChild(R, "Bartilo").HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Bartilo" then
											...
											if Configs.Farming.Sea2.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Bartilo") or not FindFirstChild(Enemy, "Bartilo")) and Configs.Farming.Sea2.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
					...
					if AnySea3 then
						if AnySea3W then
							if Configs.Farming.Sea3.AutoKillDoughKing and not getInventory("Dough King's Key", "Check") then
								if FindFirstChild(Enemy, "Dough King") then
											...
											if v.Name == "Dough King" then
												if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
													...
													repeat twait(); TargetMobName = v.Name;
														Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
														SetHum(v); Hitc();
													until not v or not Configs.Farming.Sea3.AutoKillDoughKing or v.Humanoid.Health <= 0
												end;
											end;
										end;
									end);
									...
									pcal(function()
										if FindFirstChild(R, "Dough King") then
											if Configs.Teleport.TP_Bypass and R["Dough King"] then
												TpBypass(GetPivot(R["Dough King"]));
											end; twait(0.7)
											Tp(FindFirstChild(R, "Dough King").HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Dough King" then
											...
											if Configs.Farming.Sea3.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Dough King") or not FindFirstChild(Enemy, "Dough King")) and Configs.Farming.Sea3.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
							...
							if Configs.Farming.Sea3.AutoElitehunter and not getInventory("Elite Hunter's Key", "Check") then
								if FindFirstChild(Enemy, "Diablo") or FindFirstChild(Enemy, "Deandre") or FindFirstChild(Enemy, "Urban") then
											...
											if v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban" then
												if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
													...
													repeat twait(); TargetMobName = v.Name;
														Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
														SetHum(v); Hitc();
													until not v or not Configs.Farming.Sea3.AutoElitehunter or v.Humanoid.Health <= 0
												end;
											end;
										end;
									end);
									...
									pcal(function()
										if FindFirstChild(R, "Diablo") or FindFirstChild(R, "Deandre") or FindFirstChild(R, "Urban") then
											if Configs.Teleport.TP_Bypass and (R["Diablo"] or R["Deandre"] or R["Urban"]) then
												TpBypass(GetPivot(R["Diablo"] or R["Deandre"] or R["Urban"]));
											end; twait(0.7)
											Tp((FindFirstChild(R, "Diablo") or FindFirstChild(R, "Deandre") or FindFirstChild(R, "Urban")).HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban" then
											...
											if Configs.Farming.Sea3.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Diablo") or not FindFirstChild(R, "Deandre") or not FindFirstChild(R, "Urban")) and Configs.Farming.Sea3.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
							...
							if Configs.Farming.Sea3.AutoFarmBone and not getInventory("Bone Key", "Check") then
								if FindFirstChild(Enemy, "Bone Warrior") then
									pcal(function()
										for i,v in pir(Enem) do
											if v.Name == "Bone Warrior" then
												if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
													sethiddenproperty(selff,"SimulationRadius",math.huge);
													repeat twait(); TargetMobName = v.Name;
														Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
														SetHum(v); Hitc();
													until not v or not Configs.Farming.Sea3.AutoFarmBone or v.Humanoid.Health <= 0
												end;
											end;
										end;
									end);
									...
									pcal(function()
										if FindFirstChild(R, "Bone Warrior") then
											if Configs.Teleport.TP_Bypass and R["Bone Warrior"] then
												TpBypass(GetPivot(R["Bone Warrior"]));
											end; twait(0.7)
											Tp(FindFirstChild(R, "Bone Warrior").HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Bone Warrior" then
											...
											if Configs.Farming.Sea3.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Bone Warrior") or not FindFirstChild(Enemy, "Bone Warrior")) and Configs.Farming.Sea3.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
							...
							if Configs.Farming.Sea3.AutoCakePrince and not getInventory("Cake Prince's Key", "Check") then
								if FindFirstChild(Enemy, "Cake Prince") then
											...
											if v.Name == "Cake Prince" then
												if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
													...
													repeat twait(); TargetMobName = v.Name;
														Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
														SetHum(v); Hitc();
													until not v or not Configs.Farming.Sea3.AutoCakePrince or v.Humanoid.Health <= 0
												end;
											end;
										end;
									end);
									...
									pcal(function()
										if FindFirstChild(R, "Cake Prince") then
											if Configs.Teleport.TP_Bypass and R["Cake Prince"] then
												TpBypass(GetPivot(R["Cake Prince"]));
											end; twait(0.7)
											Tp(FindFirstChild(R, "Cake Prince").HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Cake Prince" then
											...
											if Configs.Farming.Sea3.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Cake Prince") or not FindFirstChild(Enemy, "Cake Prince")) and Configs.Farming.Sea3.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
							...
							if Configs.Farming.Sea3.AutoBuddySword and not getInventory("Buddy Sword", "Check") then
								if FindFirstChild(Enemy, "Buddy") then
									pcal(function()
										for i,v in pir(Enem) do
											if v.Name == "Buddy" then
												if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
													sethiddenproperty(selff,"SimulationRadius",math.huge);
													repeat twait(); TargetMobName = v.Name;
														Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
									...
									pcal(function()
										if FindFirstChild(R, "Buddy") then
											if Configs.Teleport.TP_Bypass and R["Buddy"] then
												TpBypass(GetPivot(R["Buddy"]));
											end; twait(0.7)
											Tp(FindFirstChild(R, "Buddy").HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
											wait(1.3);
											pcal(function()
												for i,v in pir(Enem) do
													if v.Name == "Buddy" then
											...
											if Configs.Farming.Sea3.Hop then
												task.wait(3);
												if (not FindFirstChild(R, "Buddy") or not FindFirstChild(Enemy, "Buddy")) and Configs.Farming.Sea3.Hop and not Configs.Settings.AutoFarm.Stackable then
													Hop();
												end;
											end;
										end;
					...
					if Configs.System.Selected_Mob.Auto then
						if FindFirstChild(Enemy, Configs.System.Selected_Mob.Obj) then
							pcal(function()
								for i,v in pir(Enem) do
									if v.Name == Configs.System.Selected_Mob.Obj then
										if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
											sethiddenproperty(selff,"SimulationRadius",math.huge);
											repeat twait(); TargetMobName = v.Name;
												Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
												SetHum(v); Hitc();
											until not v or not Configs.System.Selected_Mob.Auto or v.Humanoid.Health <= 0
										end;
									end;
								end;
							end);
							...
							pcal(function()
								if FindFirstChild(R, Configs.System.Selected_Mob.Obj) then
									if Configs.Teleport.TP_Bypass and R[Configs.System.Selected_Mob.Obj] then
										TpBypass(GetPivot(R[Configs.System.Selected_Mob.Obj]));
									end; twait(0.7)
									Tp(FindFirstChild(R, Configs.System.Selected_Mob.Obj).HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
									wait(1.3);
									pcal(function()
										for i,v in pir(Enem) do
											if v.Name == Configs.System.Selected_Mob.Obj then
									...
									if Configs.System.Selected_Mob.Hop then
										task.wait(3);
										if (not FindFirstChild(R, Configs.System.Selected_Mob.Obj) or not FindFirstChild(Enemy, Configs.System.Selected_Mob.Obj)) and Configs.System.Selected_Mob.Hop and not Configs.Settings.AutoFarm.Stackable then
											Hop();
										end;
									end;
								end;
					...
					if Configs.System.Selected_Boss.Auto then
						if FindFirstChild(Enemy, Configs.System.Selected_Boss.Obj) then
							pcal(function()
								for i,v in pir(Enem) do
									if v.Name == Configs.System.Selected_Boss.Obj then
										if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
											sethiddenproperty(selff,"SimulationRadius",math.huge);
											repeat twait(); TargetMobName = v.Name;
												Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
												SetHum(v); Hitc();
											until not v or not Configs.System.Selected_Boss.Auto or v.Humanoid.Health <= 0
										end;
									end;
								end;
							end);
							...
							pcal(function()
								if FindFirstChild(R, Configs.System.Selected_Boss.Obj) then
									if Configs.Teleport.TP_Bypass and R[Configs.System.Selected_Boss.Obj] then
										TpBypass(GetPivot(R[Configs.System.Selected_Boss.Obj]));
									end; twait(0.7)
									Tp(FindFirstChild(R, Configs.System.Selected_Boss.Obj).HumanoidRootPart.CFrame * CF(0,35,0), Configs.Settings.AutoChest.TP_Speed);
									wait(1.3);
									pcal(function()
										for i,v in pir(Enem) do
											if v.Name == Configs.System.Selected_Boss.Obj then
									...
									if Configs.System.Selected_Boss.Hop then
										task.wait(3);
										if (not FindFirstChild(R, Configs.System.Selected_Boss.Obj) or not FindFirstChild(Enemy, Configs.System.Selected_Boss.Obj)) and Configs.System.Selected_Boss.Hop and not Configs.Settings.AutoFarm.Stackable then
											Hop();
										end;
									end;
								end;
						...
						if FindFirstChild(Enemy, Configs.System.Selected_Mob.Obj) then
									...
									if v.Name == Configs.System.Selected_Mob.Obj then
										if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
											...
											repeat twait(); TargetMobName = v.Name;
												Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
												SetHum(v); Hitc();
											until not v or not Configs.Farming.Level.AutoFarm or v.Humanoid.Health <= 0
										end;
									end;
								end;
							end);
							...
							pcal(function()
								if FindFirstChild(R, Configs.System.Selected_Mob.Obj) then
									...
									if Configs.Farming.Level.Hop then
										task.wait(3);
										if (not FindFirstChild(R, Configs.System.Selected_Mob.Obj) or not FindFirstChild(Enemy, Configs.System.Selected_Mob.Obj)) and Configs.Farming.Level.Hop and not Configs.Settings.AutoFarm.Stackable then
											Hop();
										end;
									end;
								end;
					...
					if Configs.Farming.Sea3.FullAutoAzureEmber then
						if FindFirstChild(Enemy, "Azure Ember") then
							pcal(function()
								for i,v in pir(Enem) do
									if v.Name == "Azure Ember" then
										if FindFirstChild(v, "Humanoid") and FindFirstChild(v, "HumanoidRootPart") and v.Humanoid.Health > 0 then
											...
											repeat twait(); TargetMobName = v.Name;
												Tp(v.HumanoidRootPart.CFrame * CF(Configs.Settings.AutoFarm.PosX, Configs.Settings.AutoFarm.PosY, Configs.Settings.AutoFarm.PosZ), Configs.Settings.AutoFarm.TP_Speed);
												SetHum(v); Hitc();
											until not v or not Configs.Farming.Sea3.FullAutoAzureEmber or v.Humanoid.Health <= 0
										end;
	function UpdateIsland()
		for i, v in pir(GetChildren(W._WorldOrigin.Locations)) do
			pcal(function()
...
local function getMethodLoading()
	...
	if JKLL then
		...
		local canHits = {};
		require(R.Util.CameraShaker):Stop();
		PC = require(R.CombatFramework.Particle);
		RL = require(R.CombatFramework.RigLib);
		DMG = require(R.CombatFramework.Particle.Damage);
		RigC = getupvalue(require(R.PlayerScripts.CombatFramework.RigController),2);
		Combat =  getupvalue(require(R.PlayerScripts.CombatFramework),2);
		task.spawn(function()
			local stacking = 0;
			local printCooldown = 0;
			while twait(.075) do
